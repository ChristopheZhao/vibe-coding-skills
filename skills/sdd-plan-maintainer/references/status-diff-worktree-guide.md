...
3. If index status and plan header status differ, treat index as authoritative and record a sync task.
...
3. Confirm archive path movement when status reaches `archived`.
...
3. Compare archive movement diff when closing plans.
